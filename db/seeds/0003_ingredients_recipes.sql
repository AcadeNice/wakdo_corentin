...
INSERT IGNORE INTO ingredient (name, unit, stock_quantity, stock_capacity) VALUES
  ('Pain burger', 'pièce', 300, 300),
  ('Pain sésame', 'pièce', 300, 300),
  ('Pain signature', 'pièce', 250, 250),
  ('Tortilla', 'pièce', 200, 200),
  ('Steak haché', 'pièce', 400, 400),
  ('Filet de poulet pané', 'pièce', 300, 300),
  ('Galette de poisson', 'pièce', 150, 150),
  ('Tranche de bacon', 'pièce', 500, 500),
  ('Nugget de poulet', 'pièce', 1500, 1500),
  ('Jambon', 'tranche', 200, 200),
  ('Cheddar', 'tranche', 600, 600),
  ('Fromage de chèvre', 'portion', 150, 150),
  ...
  ('Dose Ice Tea Pêche', 'dose', 1000, 1000),
  ('Dose Ice Tea Citron', 'dose', 800, 800),
  ('Dose Jus d''Orange', 'dose', 400, 400),
  ('Dose Jus de Pomme', 'dose', 400, 400),
  ('Gobelet', 'pièce', 3000, 3000),
  ('Brownie', 'pièce', 150, 150),
  ('Cheesecake', 'pièce', 150, 150),
  ('Cookie', 'pièce', 150, 150),
  ('Donut', 'pièce', 150, 150),
  ('Macaron', 'pièce', 200, 200),
  ('Glace McFleury', 'pièce', 200, 200),
  ('Muffin', 'pièce', 150, 150),
  ('Glace sundae', 'pièce', 200, 200),
...
INSERT IGNORE INTO product_ingredient (product_id, ingredient_id, quantity_normal, quantity_maxi, is_removable, is_addable, extra_price_cents) VALUES
  ...
  ((SELECT id FROM product WHERE name='Le 280'), (SELECT id FROM ingredient WHERE name='Steak haché'), 1, 1, 0, 0, 0),
  ...
  ((SELECT id FROM product WHERE name='Big Tasty'), (SELECT id FROM ingredient WHERE name='Pain sésame'), 1, 1, 0, 0, 0),
  ((SELECT id FROM product WHERE name='Big Tasty'), (SELECT id FROM ingredient WHERE name='Steak haché'), 1, 1, 0, 0, 0),
  ...
  ((SELECT id FROM product WHERE name='Big Tasty Bacon'), (SELECT id FROM ingredient WHERE name='Pain sésame'), 1, 1, 0, 0, 0),
  ((SELECT id FROM product WHERE name='Big Tasty Bacon'), (SELECT id FROM ingredient WHERE name='Steak haché'), 1, 1, 0, 0, 0),
  ...
  ((SELECT id FROM product WHERE name='Big Mac'), (SELECT id FROM ingredient WHERE name='Pain sésame'), 1, 1, 0, 0, 0),
  ((SELECT id FROM product WHERE name='Big Mac'), (SELECT id FROM ingredient WHERE name='Steak haché'), 2, 2, 0, 0, 0),
  ...
  ((SELECT id FROM product WHERE name='CBO'), (SELECT id FROM ingredient WHERE name='Filet de poulet pané'), 1, 1, 0, 0, 0),
  ...
  ((SELECT id FROM product WHERE name='MC Chicken'), (SELECT id FROM ingredient WHERE name='Pain sésame'), 1, 1, 0, 0, 0),
  ((SELECT id FROM product WHERE name='MC Chicken'), (SELECT id FROM ingredient WHERE name='Filet de poulet pané'), 1, 1, 0, 0, 0),
  ...
  ((SELECT id FROM product WHERE name='MC Crispy'), (SELECT id FROM ingredient WHERE name='Filet de poulet pané'), 1, 1, 0, 0, 0),
  ...
  ((SELECT id FROM product WHERE name='Royal Bacon'), (SELECT id FROM ingredient WHERE name='Pain sésame'), 1, 1, 0, 0, 0),
  ((SELECT id FROM product WHERE name='Royal Bacon'), (SELECT id FROM ingredient WHERE name='Steak haché'), 1, 1, 0, 0, 0),
  ...
  ((SELECT id FROM product WHERE name='Royal Cheese'), (SELECT id FROM ingredient WHERE name='Pain sésame'), 1, 1, 0, 0, 0),
  ((SELECT id FROM product WHERE name='Royal Cheese'), (SELECT id FROM ingredient WHERE name='Steak haché'), 1, 1, 0, 0, 0),
  ...
  ((SELECT id FROM product WHERE name='Royal Deluxe'), (SELECT id FROM ingredient WHERE name='Pain sésame'), 1, 1, 0, 0, 0),
  ((SELECT id FROM product WHERE name='Royal Deluxe'), (SELECT id FROM ingredient WHERE name='Steak haché'), 1, 1, 0, 0, 0),
  ...
  ((SELECT id FROM product WHERE name='Signature BBQ Beef 2 viandes'), (SELECT id FROM ingredient WHERE name='Steak haché'), 2, 2, 0, 0, 0),
  ...
  ((SELECT id FROM product WHERE name='Signature Beef BBQ'), (SELECT id FROM ingredient WHERE name='Steak haché'), 1, 1, 0, 0, 0),
  ...
  ((SELECT id FROM product WHERE name='Ice Tea Pêche'), (SELECT id FROM ingredient WHERE name='Gobelet'), 1, 1, 0, 0, 0),
  ((SELECT id FROM product WHERE name='Ice Tea Pêche'), (SELECT id FROM ingredient WHERE name='Dose Ice Tea Pêche'), 1, 1, 0, 0, 0),
  ...
  ((SELECT id FROM product WHERE name='Cheeseburger'), (SELECT id FROM ingredient WHERE name='Steak haché'), 1, 1, 0, 0, 0),
  ...
  ((SELECT id FROM product WHERE name='MC Wrap Chèvre'), (SELECT id FROM ingredient WHERE name='Tortilla'), 1, 1, 0, 0, 0),
  ((SELECT id FROM product WHERE name='MC Wrap Chèvre'), (SELECT id FROM ingredient WHERE name='Filet de poulet pané'), 1, 1, 0, 0, 0),
  ((SELECT id FROM product WHERE name='MC Wrap Chèvre'), (SELECT id FROM ingredient WHERE name='Fromage de chèvre'), 1, 1, 1, 0, 0),
  ((SELECT id FROM product WHERE name='MC Wrap Chèvre'), (SELECT id FROM ingredient WHERE name='Salade'), 1, 1, 1, 0, 0),
  ((SELECT id FROM product WHERE name='MC Wrap Chèvre'), (SELECT id FROM ingredient WHERE name='Tomate'), 1, 1, 1, 0, 0),
  ((SELECT id FROM product WHERE name='MC Wrap Chèvre'), (SELECT id FROM ingredient WHERE name='Sauce ranch'), 1, 1, 1, 0, 0),
  ((SELECT id FROM product WHERE name='MC Wrap Poulet Bacon'), (SELECT id FROM ingredient WHERE name='Tortilla'), 1, 1, 0, 0, 0),
  ((SELECT id FROM product WHERE name='MC Wrap Poulet Bacon'), (SELECT id FROM ingredient WHERE name='Filet de poulet pané'), 1, 1, 0, 0, 0),
  ...
  ((SELECT id FROM product WHERE name='Ptit Wrap Chèvre'), (SELECT id FROM ingredient WHERE name='Tortilla'), 1, 1, 0, 0, 0),
  ((SELECT id FROM product WHERE name='Ptit Wrap Chèvre'), (SELECT id FROM ingredient WHERE name='Filet de poulet pané'), 1, 1, 0, 0, 0),
  ((SELECT id FROM product WHERE name='Ptit Wrap Chèvre'), (SELECT id FROM ingredient WHERE name='Fromage de chèvre'), 1, 1, 1, 0, 0),
  ((SELECT id FROM product WHERE name='Ptit Wrap Chèvre'), (SELECT id FROM ingredient WHERE name='Salade'), 1, 1, 1, 0, 0),
  ((SELECT id FROM product WHERE name='Ptit Wrap Chèvre'), (SELECT id FROM ingredient WHERE name='Sauce ranch'), 1, 1, 1, 0, 0),
  ((SELECT id FROM product WHERE name='Ptit Wrap Ranch'), (SELECT id FROM ingredient WHERE name='Tortilla'), 1, 1, 0, 0, 0),
  ((SELECT id FROM product WHERE name='Ptit Wrap Ranch'), (SELECT id FROM ingredient WHERE name='Filet de poulet pané'), 1, 1, 0, 0, 0),
  ...
  ((SELECT id FROM product WHERE name='César Classic'), (SELECT id FROM ingredient WHERE name='Salade'), 1, 1, 0, 0, 0),
  ((SELECT id FROM product WHERE name='César Classic'), (SELECT id FROM ingredient WHERE name='Filet de poulet pané'), 1, 1, 0, 0, 0),
  ((SELECT id FROM product WHERE name='César Classic'), (SELECT id FROM ingredient WHERE name='Emmental'), 1, 1, 1, 0, 0),
  ((SELECT id FROM product WHERE name='César Classic'), (SELECT id FROM ingredient WHERE name='Tomate'), 1, 1, 1, 0, 0),
  ((SELECT id FROM product WHERE name='César Classic'), (SELECT id FROM ingredient WHERE name='Sauce ranch'), 1, 1, 1, 0, 0),
  ((SELECT id FROM product WHERE name='César Classic'), (SELECT id FROM ingredient WHERE name='Tranche de bacon'), 1, 1, 1, 1, 80),
