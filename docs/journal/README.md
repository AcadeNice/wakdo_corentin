...
| 2026-09-22 | [remediation-cd-mono-hote-et-bloc1](2026-09-22--remediation-cd-mono-hote-et-bloc1.md) | Synthese #131-#142 : documentation remise en accord avec le code (Merise, preuves, comptes de criteres), deploiement continu mono-hote rendu operationnel et verifie en production pour la premiere fois, depot d'images securise complete en TDD, remediation Bloc 1 (lien d'evitement, accessibilite du back-office, audit de contraste mesure 10 violations vers 0, animation JavaScript). Erreurs de session et pieges consignes. | `dev`/`main` (PR #131 a #142) |
